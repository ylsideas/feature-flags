...
class GatewayInspectorTest extends TestCase
{
    ...
    public function test_it_will_skip_to_the_next_inspector_when_a_result_exists()
    {
        $gateway = \Mockery::mock(Gateway::class);
    ...
    public function test_it_filter_features_while_inspecting()
    {
        $gateway = \Mockery::mock(Gateway::class);
        $action = new ActionableFlag();
    ...
    public function test_it_uses_configured_caches()
    {
        $gateway = \Mockery::mock(Gateway::class);
        $action = new ActionableFlag();
        $action->feature = 'my-feature';
    ...
    public function test_it_stores_results_in_caches()
    {
        $gateway = \Mockery::mock(Gateway::class);
        $action = new ActionableFlag();
        $action->feature = 'my-feature';
    ...
    public function test_it_sets_results_in_the_action()
    {
        $gateway = \Mockery::mock(Gateway::class);
        $action = new ActionableFlag();
        $action->feature = 'my-feature';
